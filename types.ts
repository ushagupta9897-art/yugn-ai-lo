...
// --- New, more strategic types for Google Ads Keywords ---
...
export interface GoogleAdsKeywordGroup {
    theme: string; // e.g., "High-Intent Purchase Keywords", "Competitor Keywords"
    justification: string; // Why this group is important
...
// New type for planner prefill
export interface PlannerPrefillParams {
    topic: string;
    generatedContent?: string;
    contentType?: string;
    action?: 'prefill' | 'generate';
}
...
export interface PersonaFeedback {
    ...
    groundingFact?: string; // New field for evidence-based feedback
    groundingUrl?: string; // New field for source verification
}
...
export type PublicPage = 'landing' | 'about';
...
export interface AppContextType {
  ...
  setScrollToHash: (hash: string | null) => void;
  ...
  // For cross-tab data pre-filling
  contentGeneratorPrefill: ContentGenerationParams | null;
  setContentGeneratorPrefill: (params: ContentGenerationParams | null) => void;
  plannerPrefill: PlannerPrefillParams | null;
  setPlannerPrefill: (params: PlannerPrefillParams | null) => void;
}