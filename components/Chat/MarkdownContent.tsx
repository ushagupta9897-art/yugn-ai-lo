...
const sanitizeAndFormat = (text: string): string => {
  // FIX: Add a defensive check to ensure the input is a string. This prevents
  // the "text.replace is not a function" error if an unexpected non-string
  // value (like null or undefined) is passed from an API response.
